...
const app = express();
const ticketSubmittedRoutes = express.Router();

// Require 'Branch' model in our routes module
let Ticket = require('../models/Ticket');

// Defined store route
/*ticketSubmittedRoutes.route('/branch/add').post(function (req, res) {
...
ticketSubmittedRoutes.route('/branch').get(function (req, res) {
...
// Defined edit route
ticketSubmittedRoutes.route('/view/:id').get(function (req, res) {
...
ticketSubmittedRoutes.route('/update/:id').post(function (req, res) {
  Ticket.findById(req.params.id, function(err, ticket) {
    if (!ticket)
      return next(new Error('Could not load Document'));
    else {
      ticket.received_by = req.body.received_by;
      ticket.received_by_name = req.body.received_by_name;
...
/*ticketSubmittedRoutes.route('/branch/show').get(function (req, res) {
...
module.exports = ticketSubmittedRoutes;