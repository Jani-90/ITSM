...
import { job } from '../itsm';

@Component({
  selector: 'app-job-process-inhouse',
  templateUrl: './job-process-inhouse.component.html',
  styleUrls: ['./job-process-inhouse.component.css']
})
export class JobProcessInhouseComponent implements OnInit {
  ...
  createForm() {
    ...
    this.angForm4 = this.fb.group({
      inhouse_closing_comment: ['', Validators.required ],
      ticket_status4: [''],
      job_status4:[''],
      ticket_no4: ['']
...
console.log(this.quo.job_status);
  ...
  UpdateJobInhouseClose(inhouse_closing_comment, job_status4) {
    this.route.params.subscribe(params => {
       this.job.UpdateJobInhouseClose(inhouse_closing_comment, job_status4, params['id']);
       alert('Job Updated Successfully');
       window.location.reload();
       //this.router.navigate(['']);
  ...
  UpdateTicketInhouseClose(ticket_status4, ticket_no4) {
    this.route.params.subscribe(params => {
       this.tkt.UpdateTicketInhouseClose(ticket_status4, ticket_no4);
       //alert('Ticket Received Successfully');
       //window.location.reload();
       //this.router.navigate(['']);
